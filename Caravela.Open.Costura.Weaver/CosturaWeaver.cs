            ...
            if (compilation.LanguageVersion < LanguageVersion.CSharp9)
            {
                context.Diagnostics.AddDiagnostic(Diagnostic.Create(
                    new DiagnosticDescriptor(
                        "CO001", "Language version too low", "RoslynEx.Constura requires language version at least 9.0, but it's set to {0}.", "Caravela.Open.Costura", DiagnosticSeverity.Error, true),
