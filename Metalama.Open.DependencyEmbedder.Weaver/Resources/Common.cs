...
namespace Metalama.Open.DependencyEmbedder.Weaver.Templates
{
    internal static class Common
    {
        ...
        public static void Log(string format, params object[] args)
        {
            ...
            Debug.WriteLine("=== DependencyEmbedder === " + string.Format(format, args));
        }
        ...
        public static void PreloadUnmanagedLibraries(string hash, string tempBasePath, List<string> libs, Dictionary<string, string> checksums)
        {
            ...
            var mutexId = $"DependencyEmbedder{hash}";
        ...
        static string ResourceNameToPath(string lib)
        {
            ...
            if (lib.StartsWith(string.Concat("DependencyEmbedder", bittyness, ".")))
            {
                name = Path.Combine(bittyness, lib.Substring(10));
            }
            else if (lib.StartsWith("DependencyEmbedder."))
            {
